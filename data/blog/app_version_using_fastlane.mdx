...
<Image
  ...
  sizes="(max-width: 768px) 100vw,
                ...
                56rem"
  src="https://res.cloudinary.com/dcy3ccdem/image/upload/v1676277793/app_version_using_fastlane/0_utz3Be9wi7gdB-m6_vftvg6.webp"
/>
https://n8d.at/how-to-version-new-sharepoint-framework-projects/semantic-version
...
우리가 할 버저닝 자동화의 대략적인 흐름은 다음과 같습니다.
...
이제 한 줄로 소스 코드의 버전 업, 소스 코드 버전에 따라 각 플랫폼의 버전 업을 해 봅시다.
